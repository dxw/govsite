!function(a, b, c, d) {
    ...
    Foundation.libs.abide = {
        ...
        check_validation_and_apply_styles: function(b) {
            ...
            for (e.data(this.attr_name(!0) + "-init") || {}; c--; ) {
                ...
                l && (g = this.settings.validators[l].apply(this, [ h, i, f ]), q.push(g)), m && i) q.push(this.valid_radio(h, i)); else if (n && i) q.push(this.valid_checkbox(h, i)); else {
                    if (q.push(b[c][1].test(j) && p || !i && h.value.length < 1 || a(h).attr("disabled") ? !0 : !1), 
                    q = [ q.every(function(a) {
                        return a;
                    }) ], q[0]) this.S(h).removeAttr(this.invalid_attr), h.setAttribute("aria-invalid", "false"), 
                    h.removeAttribute("aria-describedby"), f.removeClass("error"), o.length > 0 && this.settings.error_labels && o.removeClass("error").removeAttr("role"), 
                    a(h).triggerHandler("valid"); else {
                        this.S(h).attr(this.invalid_attr, ""), h.setAttribute("aria-invalid", "true");
                        var r = f.find("small.error, span.error"), s = r.length > 0 ? r[0].id : "";
                        s.length > 0 && h.setAttribute("aria-describedby", s), f.addClass("error"), o.length > 0 && this.settings.error_labels && o.addClass("error").attr("role", "alert"), 
        ...
        valid_equal: function(a, b, d) {
            ...
            return g ? (this.S(a).removeAttr(this.invalid_attr), d.removeClass("error"), label.length > 0 && settings.error_labels && label.removeClass("error")) : (this.S(a).attr(this.invalid_attr, ""), 
            d.addClass("error"), label.length > 0 && settings.error_labels && label.addClass("error")), 
            g;
        },
    ...
    Foundation.libs.accordion = {
        ...
        events: function() {
            ...
            c(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a", function(d) {
                ...
                return d.preventDefault(), e.attr(b.attr_name()) && (j = j.add("[" + f + "] dd > .content"), 
    ...
    Foundation.libs.tab = {
        ...
        toggle_active_tab: function(e, f) {
            ...
            n.callback(e), l.children().attr("tab-index", 0), l.triggerHandler("toggled", [ e ]), 
            h.triggerHandler("toggled", [ l ]), i.on("keydown", o);
        },
        data_attr: function(a) {
            return this.namespace.length > 0 ? this.namespace + "-" + a : a;
        },
